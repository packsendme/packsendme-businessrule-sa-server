pipeline {
    ...
    environment {
        NAME_CONTAINER = "businessrule-sa-microservice-psm"
        NAME_IMAGE = "businessrule-sa-image-psm:1"
        ID_CONTAINER = null 
    ...
    stages {
        ...
        stage('Git Checkout Repositorio') {
            steps {
                git branch: 'develop',
                url: 'https://github.com/packsendme/packsendme-businessrule-sa-server.git'
            }
        }
        stage('Java Build') {
          steps {
