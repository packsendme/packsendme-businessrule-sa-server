...
@Service
public class BusinessRuleEuaService {
	...
	public ResponseEntity<?> saveBusinessRuleEua(BusinessRulesModel businessrule) {		
		ObjectMapper mapper = new ObjectMapper();
		Response<String> responseObj = null;

		try {
			String ruleJson = mapper.writeValueAsString(businessrule);
	        this.kafkaTemplate.send(configuration.topic_simulation_eua, ruleJson);
