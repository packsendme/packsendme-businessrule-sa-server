...
@Service
public class BusinessRuleSAService {
	...
	public ResponseEntity<?> saveBusinessRuleSA(BusinessRulesModel businessrule) {		
		ObjectMapper mapper = new ObjectMapper();
		Response<String> responseObj = null;

		try {
			String ruleJson = mapper.writeValueAsString(businessrule);
	        this.kafkaTemplate.send(configuration.topic_simulation_southamerica, ruleJson);
