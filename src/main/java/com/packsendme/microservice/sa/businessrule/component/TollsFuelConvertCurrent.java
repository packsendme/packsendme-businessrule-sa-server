...
public class TollsFuelConvertCurrent {
	...
	public TollsFuelBRE_Model opGETConvertToCountryOrigin(TollsFuelBRE_Model tollsFuelBRE, String country) {
		...
		tollsfuelPriceCountry.fuel_price = tollsfuelPriceCountry.fuel_price * tollsfuelPriceCountry.rate_exchange;
		tollsfuelPriceCountry.tolls_price = tollsfuelPriceCountry.tolls_price * tollsfuelPriceCountry.rate_exchange;
	...
	public TollsFuelBRE_Model opPOSTConvertToDollar(TollsFuelBRE_Model tollsFuelBRE, double vlr_rate, String country) {
		...
		tollsfuelPriceCountry.fuel_price = tollsfuelPriceCountry.fuel_price / vlr_rate;
		tollsfuelPriceCountry.tolls_price = tollsfuelPriceCountry.tolls_price / vlr_rate;
